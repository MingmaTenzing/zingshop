...
function Newsletter({}: Props) {
  return (
    <div className="bg-[#131920] mt-10 p-4 py-14 space-y-3 md:px-[200px]">
      ...
      <FacebookIcon  className='text-white hover:text-zingyellow transition-all ease-linear duration-200 ' sx={{fontSize:'30px'}}/>
      <InstagramIcon  className='text-white hover:text-zingyellow transition-all ease-linear duration-200' sx={{fontSize:'30px'}}/>
      <YouTubeIcon  className='text-white hover:text-zingyellow transition-all ease-linear duration-200' sx={{fontSize:'30px'}}/>
    </div>
